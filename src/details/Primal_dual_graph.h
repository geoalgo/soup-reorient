...
typedef typename Primal_graph::vertex_descriptor Graph_vertex_descriptor;
typedef typename Primal_graph::edge_descriptor Graph_edge_descriptor;
typedef typename Primal_graph::vertex_iterator Graph_vertex_iterator;
typedef typename Primal_graph::edge_iterator Graph_edge_iterator;
